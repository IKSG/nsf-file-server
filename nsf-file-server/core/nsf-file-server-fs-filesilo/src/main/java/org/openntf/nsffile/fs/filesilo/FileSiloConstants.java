 ...
 * @since 1.0.0
 */
public enum FileSiloConstants {
	;
	
	/** The form name used for file documents */
	public static final String FORM_FILE = "file"; //$NON-NLS-1$
	/** The item in File documents used to store the human-readable name */
	public static final String ITEM_ID = "fileID"; //$NON-NLS-1$
	/** The item in File documents used to store the unique auto-generated key */
	public static final String ITEM_KEY = "fileKey"; //$NON-NLS-1$
	/** The rich text item in File documents used to store the file attachment */
	public static final String ITEM_FILE = "fileAttachment"; //$NON-NLS-1$
