 ...
 */
package org.openntf.nsffile.fs.nsfwebcontent.provider;
...
public class WebContentMountProvider implements FileSystemMountProvider {
	public static final String KEY_USERNAME = "username"; //$NON-NLS-1$

	@Override
	public String getName() {
		return WebContentFileSystemProvider.SCHEME;
	}
	...
	public FileSystem createFileSystem(String dataSource, Map<String, Object> env) throws IOException {
		...
		try {
			URI uri = WebContentPathUtil.toFileSystemURI(username, dataSource);
			return WebContentFileSystemProvider.instance.getOrCreateFileSystem(uri, Collections.emptyMap());
